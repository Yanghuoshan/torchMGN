...
class InteractionNetwork(MessagePassing):
  ...
  def message(self,
    ...
    self.new_edge_features = edge_features # Use a member variable to store updated edge_features
    return self.new_edge_features
  ...
  def update(self,
    ...
    return x_updated, self.new_edge_features # Use the member variable to output
