...
import data_loader
import learned_simulator_modified
from noise import get_velocity_noise
from utils import datas_to_graph
...
def predict(simulator: learned_simulator_modified.MeshSimulator,
            device: str):
...
def rollout(simulator: learned_simulator_modified.MeshSimulator,
            features,
            nsteps: int,
            device):
...
def main(_):
    ...
    # load simulator
    simulator = learned_simulator_modified.MeshSimulator(
