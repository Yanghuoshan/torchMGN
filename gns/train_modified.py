...
from gns import learned_simulator_modified
...
def rollout(
        simulator: learned_simulator_modified.LearnedSimulator,
...
def _get_simulator(
        ...
        acc_noise_std: float,
        vel_noise_std: float,
        device: torch.device) -> learned_simulator_modified.LearnedSimulator:
