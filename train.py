...
from model_utils import HyperEl,Cloth,Easy_HyperEl,IncompNS,CFD,Inflaction,HyperEl2d
...
flags.DEFINE_string('model', 'Cloth', 'Select model to run. Such as HyperEl, Cloth, IncompNS, CFD')
...
flags.DEFINE_string('dataset', 'flag_simple', 'Select dataset to run. Such as deforming_plate, flag_simple, my_dataset, waterballoon_dataset')
